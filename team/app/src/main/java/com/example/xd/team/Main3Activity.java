...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv24.setText(bundle.getString("name"));
        tv25.setText("球队/"+bundle.getString("team"));
        tv26.setText(bundle.getString("number"));
        tv27.setText("位置/"+bundle.getString("position"));
        iv.setImageResource(getImageFromResourceByReflect("player"+bundle.getInt("player_id")));
        double perEv = bundle.getDouble("perEv");
        int score = (int)Math.floor(100*perEv/27.9);
        tv28.setText("评分/"+score);
        tv29.setText("薪资/"+bundle.getInt("salary")+"万");
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if (status == 1) {
                                        ...
                                        Toast.makeText(Main3Activity.this, "解雇成功", Toast.LENGTH_SHORT).show();
                                        json = playerDao.teamInit(user_id, player_id,"ssm/team/teamShow.json");
                                        intent = new Intent(Main3Activity.this,MainActivity.class);
                                        JSONArray jsonArray = json.getJSONArray("list");
                                        Log.i("tag","aaa"+jsonArray.getJSONObject(0));
                                        ...
                                        Log.i("tag", "succ");
                                        Toast.makeText(Main3Activity.this, "球员正在首发位置上，不能解雇", Toast.LENGTH_SHORT).show();
                                    }
    ...
    public void replace(final int user_id, final int player_in_id){
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(items, 1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Main3Activity.this, items[which], Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
                                ...
                                if(items[which].equals("C")){
                                    ...
                                    try{
                                        ...
                                        if(json.getInt("ststus") == 1){
                                            Toast.makeText(Main3Activity.this, "替换成功", Toast.LENGTH_SHORT).show();
                                        }else{
                                            Toast.makeText(Main3Activity.this, "替换失败", Toast.LENGTH_SHORT).show();
                                        }
                                    }catch (Exception e){
                                        e.toString();
                                    }
