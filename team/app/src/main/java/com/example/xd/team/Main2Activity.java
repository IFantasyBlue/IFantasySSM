...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv4.setText(bundle.getString("draft"));
        tv6.setText("球队/"+bundle.getString("team"));
        tv7.setText(bundle.getString("number"));
        ...
        tv12.setText("身高/"+bundle.getDouble("height")+"m"+"体重/"+bundle.getDouble("weight")+"KG"+"站立摸高/"+bundle.getDouble("standTall")+"cm"+"臂展/"+bundle.getDouble("arms")+"cm");
        final int user_id = bundle.getInt("user_id");
        final int player_id = bundle.getInt("player_id");
        iv.setImageResource(getImageFromResourceByReflect("player"+player_id));
        ...
        new Thread(){
            public void run (){
                ...
                try {
                    ...
                    bundle.putDouble("perEv",json.getDouble("per"));
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            if (status == 1) {
                                                ...
                                                Toast.makeText(Main2Activity.this, "解雇成功", Toast.LENGTH_SHORT).show();
                                                json = playerDao.teamInit(user_id, player_id,"ssm/team/teamShow.json");
                                                intent = new Intent(Main2Activity.this,MainActivity.class);
                                                JSONArray jsonArray = json.getJSONArray("list");
                                                Log.i("tag","aaa"+jsonArray.getJSONObject(0));
                                                ...
                                                Log.i("tag", "succ");
                                                Toast.makeText(Main2Activity.this, "球员正在首发位置上，不能解雇", Toast.LENGTH_SHORT).show();
                                            }
                                        ...
                                        if(items[which].equals("C")){
                                            ...
                                            try{
                                                ...
                                                if(json.getInt("ststus") == 1){
                                                    Toast.makeText(Main2Activity.this, "替换成功", Toast.LENGTH_SHORT).show();
                                                }else{
                                                    Toast.makeText(Main2Activity.this, "替换失败", Toast.LENGTH_SHORT).show();
                                                }
                                            }catch (Exception e){
                                                e.toString();
                                            }
