            ...
            public void run (){
                ...
                try {
                    ...
                    for(i=0;i<jsonArray.length();i++){
                        ...
                        membersVO.setTeamMembers(teamMembers);
                        tv[i].setText(membersVO.getName()+"");
                        iv[i].setImageResource(getImageFromResourceByReflect("player"+json2.getInt("playerId")));
                        Log.i("qqq",i+"");
                    }
                    for(;i<10;i++){
                        tv[i].setText("");
