...
setTimeout(function () { this.location.href = "http://localhost:8080/ssm/matching/FinghtingEnd?user_id="+<%=request.getAttribute("user_id") %>+"&user2_id="+<%=request.getAttribute("user2_id") %> }, 1000);
</script> 
  <body>  
